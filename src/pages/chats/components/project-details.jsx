...
import { ShapesIcon as AttachmentIcon, ImageIcon, Loader2 } from "lucide-react";
...
function ProjectDetails({ project, setOpen }) {
        ...
        <div className="flex gap-2 items-center">
          <Avatar className="flex items-center justify-center size-6">
            ...
            <AvatarFallback className="flex bg-foreground items-center text-xs justify-center w-full h-full text-card">
              {project?.creator?.fullName[0].toUpperCase()}
            </AvatarFallback>
          </Avatar>

          <h1 className="font-medium text-sm">{project.creator?.fullName}</h1>
        </div>
