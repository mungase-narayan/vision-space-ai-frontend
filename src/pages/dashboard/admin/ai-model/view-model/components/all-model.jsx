...
function AllModel({ models: _selectedModels, onSave, isLoading, setOpen }) {
          ...
          {filteredModels.map((model) => (
            ...
            >
              ...
              <td className="px-3 py-2">
                ${round(model?.pricing?.prompt * 1000000, 2)}/1M
              </td>
              <td className="px-3 py-2">
                ${round(model?.pricing?.completion * 1000000, 2)}/1M
              </td>
              <td className="px-3 py-2">
                ${round(model?.pricing?.image * 1000, 3)}/1K
              </td>
              <td className="px-3 py-2">
